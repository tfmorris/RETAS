...
/**
 * This class simply merges hyphenated tokens at the end of each line. 
 * Ignores the characters in the INGORED_CHARS list.
 * 
...
public class TextPreprocessorUniversal extends TextPreprocessor{
    ...
    public String processText(String s) {
        ...
        for (int i = 0; i < charAr.length; i++) {
            ...
            // connect syllables of words which are separated by a dash
            // -------------------------------------------------------------
