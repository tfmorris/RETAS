...
Example command: java RecursiveAlignmentTool texts/adventuresofhuck_gutenberg.txt texts/adventuresofhuck00clemrich.txt alignmentOutput.txt -opt config.txt
